...
//
//     final focusedWellbeingTime = focusedWellbeingTimeFromJson(jsonString);

import 'dart:convert';

FocusedWellbeingTime focusedWellbeingTimeFromJson(String str) => FocusedWellbeingTime.fromJson(json.decode(str));

String focusedWellbeingTimeToJson(FocusedWellbeingTime data) => json.encode(data.toJson());

class FocusedWellbeingTime {
  FocusedWellbeingTime({
    this.msg,
  ...
  factory FocusedWellbeingTime.fromJson(Map<String, dynamic> json) => FocusedWellbeingTime(
    msg: json["msg"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    leaderShipTask: json["leader_ship_task"],
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "leader_ship_task": leaderShipTask,
  };
}
